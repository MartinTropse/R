...
setwd("C:/Users/MartinAndersson/AquaBiota/Gruppwebbplats för AquaBiota - Documents/PROJEKT/2020016 Tumlarundersökningar Aurora/2_Arbetsdokument_tunga_filer_använd_P/Fält_December_2021/CTD-data/Excel-filer")

wndPark=readline() #Enter the project windpark


df=read.csv("FC060943_78.CSV", sep =';')
...
newFrame=newFrame[which(newFrame$`Press_[dbar]`>0.5),] #Removes lines with salinity under 1.5 promile, change in freshwater areas.   
...
bp=bp+labs(x="Station 1",y="Djup (m)", title=paste(wndPark,theTime))
...
bp=bp+scale_color_manual(labels = c("Temperatur�C", "Salinitet (PSU)", "Syre (ml/l)"),
                         values = c("#009688", "#b3dca0", "#83d0c9"))
#"#258a63", "#ff0000", "#0a75ad" Difference color scheme. 
bp


df=read.csv("F9060928_24.CSV", sep =',')
aDate=df[2,]
