...
resSumry=paste0("ResultSumry_",hostOrg,txtTree,txtLeaf,"_",lubridate::as_date(Sys.time()),"_predCT_",hostBinaryCutoff,".txt")
#Determines where the export file goes
setwd("C:/Base/Project/ECWA-NOR/PCR_Sekvenser/ECWANOR_202212/alignment/input_ML/202303")
