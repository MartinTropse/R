...
setwd("C:/Users/MartinAndersson/Calluna AB/JAG0092-1_CCS_2021 - Dokument/JAG0092b_Hydrografi/Arbetsdokument/Rådata CTD 2022/Previous")
...
#myGpkg=paste0("CTD_GeoSlite1",".gpkg")
...
sttStr = "https://callunaab.sharepoint.com/teams/JAG0092-1/Delade%20dokument/Forms/AllItems.aspx?id=%2Fteams%2FJAG0092%2D1%2FDelade%20dokument%2FJAG0092b%5FHydrografi%2FArbetsdokument%2FCTD%2FGraphs%2FCTD%5FGraph%5F"
#endStr = "5F2022%2D08%2D11%2Epdf&parent=%2Fteams%2FJAG0092%2D1%2FDelade%20dokument%2FJAG0092b%5FHydrografi%2FArbetsdokument%2FCTD%2FGraphs"
...
srtMon=min(lubridate::month(subMlt$Datum, label = TRUE))
endMon=max(lubridate::month(subMlt$Datum, label = TRUE))
srtYr=min(lubridate::year(subMlt$Datum))
endYr=max(lubridate::year(subMlt$Datum))
